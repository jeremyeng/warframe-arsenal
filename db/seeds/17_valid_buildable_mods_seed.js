function linkTableWithModTypes(tableName, modTypes, knex, Promise) {
  return knex('mods')
    ...
    .select('mod_id')
    .then(modIds => knex(tableName)
      .select('buildable_id', 'buildable_type')
      .then(result => Promise.all(
        result.map(({ buildable_id: buildableId, buildable_type: buildableType }) => Promise.all(
          modIds.map(({ mod_id: modId }) => knex('valid_buildable_mods').insert({
...
exports.seed = (knex, Promise) => knex.transaction(trx => Promise.all(
  ...
  linkWeaponTypeWithModTypes('Bow', ['Primary', 'Rifle', 'Bow'], trx, Promise),
  linkWeaponTypeWithModTypes('Crossbow', ['Primary', 'Rifle', 'Crossbow'], trx, Promise),
  linkWeaponTypeWithModTypes('Shotgun', ['Primary', 'Shotgun'], trx, Promise),
  linkWeaponTypeWithModTypes('Sniper Rifle', ['Primary', 'Rifle', 'Sniper Rifle'], trx, Promise),
  linkWeaponTypeWithModTypes('Spear Gun', ['Primary', 'Rifle', 'Spear Gun'], trx, Promise),
  linkWeaponTypeWithModTypes('Pistol', ['Secondary', 'Pistol'], trx, Promise),
  linkWeaponTypeWithModTypes('Dual Pistols', ['Secondary', 'Dual Pistols'], trx, Promise),
  linkWeaponTypeWithModTypes('Thrown', ['Secondary', 'Pistol', 'Thrown'], trx, Promise),
  linkWeaponTypeWithModTypes('Shotgun Sidearm', ['Secondary', 'Shotgun Sidearm'], trx, Promise),
  linkWeaponTypeWithModTypes('Blade and Whip', ['Melee', 'Blade and Whip'], trx, Promise),
  linkWeaponTypeWithModTypes('Claws', ['Melee', 'Claws'], trx, Promise),
  linkWeaponTypeWithModTypes('Dagger', ['Melee', 'Dagger'], trx, Promise),
  linkWeaponTypeWithModTypes('Dual Daggers', ['Melee', 'Dual Daggers'], trx, Promise),
  linkWeaponTypeWithModTypes('Fist', ['Melee', 'Fist'], trx, Promise),
  linkWeaponTypeWithModTypes('Glaive', ['Melee', 'Glaive'], trx, Promise),
  linkWeaponTypeWithModTypes('Gunblade', ['Melee', 'Gunblade'], trx, Promise),
  linkWeaponTypeWithModTypes('Hammer', ['Melee', 'Hammer'], trx, Promise),
  linkWeaponTypeWithModTypes('Heavy Blade', ['Melee', 'Heavy Blade'], trx, Promise),
  linkWeaponTypeWithModTypes('Machete', ['Melee', 'Machete'], trx, Promise),
  linkWeaponTypeWithModTypes('Nikana', ['Melee', 'Nikana'], trx, Promise),
  linkWeaponTypeWithModTypes('Nunchaku', ['Melee', 'Nunchaku'], trx, Promise),
  ...
  linkWeaponTypeWithModTypes('Sparring', ['Melee', 'Sparring'], trx, Promise),
  linkWeaponTypeWithModTypes('Staff', ['Melee', 'Staff'], trx, Promise),
  linkWeaponTypeWithModTypes('Sword and Shield', ['Melee', 'Sword and Shield'], trx, Promise),
